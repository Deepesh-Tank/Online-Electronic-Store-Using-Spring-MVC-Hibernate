...
<div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form:form  action="${pageContext.request.contextPath}/transportation/inserting" modelAttribute="x" method="POST">
                    <form:hidden path="messageId"></form:hidden>
				 	...
				 	<form:hidden path="date"></form:hidden>
                        <div class="form-row">
                            <div class="name">Message</div><br>
                            <div class="value">
                                <div class="input-group">
                                    <form:input path="messageInfo" class="input--style-5" />
                                    <label class="label--desc"> <form:errors path="messageInfo" /></label>
                                </div>
                            </div>
                        </div>
                        <div>
