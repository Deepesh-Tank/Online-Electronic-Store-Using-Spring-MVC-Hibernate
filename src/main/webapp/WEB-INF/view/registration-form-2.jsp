...
<title>Register New Transporter</title>
...
<script
 ...
 <style>
		   body {
    				background-image: url('${pageContext.request.contextPath}/resources/images/backgroung.jpg');back.png');
		...
		<div id="loginbox" style="margin-top: 200px; margin-left: 575px;"
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading">
					<div class="panel-title">Register New Transport Company</div>
				</div>
				...
				<div style="padding-top: 30px" class="panel-body">
					...
					<!-- Registration Form -->
					<form:form
						action="${pageContext.request.contextPath}/transportation/processRegistrationFormTransport"
